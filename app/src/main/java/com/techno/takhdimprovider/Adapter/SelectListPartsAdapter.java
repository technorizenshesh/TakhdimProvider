...
import com.techno.takhdimprovider.Activity.AddPartDetailsActivity;
...
public class SelectListPartsAdapter extends RecyclerView.Adapter<SelectListPartsAdapter.ViewHolder> {
    private Activity activity;
    private List<CategoryListResult> result;

    public SelectListPartsAdapter(Activity activity, List<CategoryListResult> result) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            Intent i = new Intent(activity, AddPartDetailsActivity.class);
            i.putExtra("part_id", "" + result.get(getAdapterPosition()).getId());
