...
import com.techno.takhdimprovider.Response.ChatResponse;
...
//    }
    ...
    private void getChat1() {
        ...
        Call<ResponseBody> call = AppConfig.loadInterface().getChat1(DataHolder.getSender(), DataHolder.getReciver());
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        if (object.getString("status").equals("1")) {
                            Gson gson = new Gson();
                            ChatResponse requestListResponse = gson.fromJson(responseData, ChatResponse.class);
                            int i;
